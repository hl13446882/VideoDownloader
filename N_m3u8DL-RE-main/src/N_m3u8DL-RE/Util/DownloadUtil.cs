        ...
        try
        {
            ...
            if (fromPosition != null || toPosition != null)
            {
                ...
                if (response.StatusCode != System.Net.HttpStatusCode.PartialContent ||
                    range?.From != (fromPosition ?? 0) || (toPosition != null && range.To != toPosition))
                    throw new IOException("Server returned a mismatched byte range.");
            }
            ...
            if (contentLength.HasValue && stream.Length != contentLength.Value)
                throw new IOException("Incomplete media response.");
            return new DownloadResult()
            {
